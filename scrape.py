...
print("Namn;Märke;Pris;Förmånsvärde;Url")
...
for brand in brands:
    ...
    for car in cars:
        ...
        for variant in variants:
            ...
            print(namnEl[0].text + ";" +brand.findAll("span", {"style": "font-size: 1.2em;font-weight: 600"})[0].text + ";"  + priceEl[0].text.strip() + ";" + förmånsEl.text.strip() + ";" + baseurl + namnEl[0]["href"])
